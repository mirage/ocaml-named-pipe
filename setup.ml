...
(* OASIS_START *)
(* DO NOT EDIT (digest: 54a59cc5a3e4f626c78973b98a55b503) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
            ...
            [
               Library
                 ({
                  ...
                  },
                   {
                      ...
                      bs_c_sources = ["named_pipe_stubs.c"];
                      bs_data_files = [];
                   ...
                   {
                      lib_modules = ["Named_pipe"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "named-pipe";
                      lib_findlib_containers = []
                   });
               Library
                 ({
                     cs_name = "named-pipe_lwt";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "lwt";
                      bs_compiled_object = Best;
                      bs_build_depends = [FindlibPackage ("lwt", None)];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = ["named_pipe_lwt_stubs.c"];
                      bs_data_files = [];
                      bs_ccopt =
                   ...
                   {
                      lib_modules = ["Named_pipe_lwt"];
                      lib_pack = false;
                      lib_internal_modules = [];
                      lib_findlib_parent = Some "named-pipe";
               ...
               Executable
                 ({
                  ...
                  },
                   {
                      ...
                      bs_build_depends =
                        [
                           ...
                           InternalLibrary "named-pipe";
                           InternalLibrary "named-pipe_lwt";
                   ...
                   {exec_custom = false; exec_main_is = "pipecat.ml"});
               Executable
                 ({
                     cs_name = "test";
                     cs_data = PropList.Data.create ();
          ...
          plugins =
            [(`Extra, "META", Some "0.3"); (`Extra, "DevFiles", Some "0.4")];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "Ì\144­›a.q¹†ú­\152¯š\1444";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
